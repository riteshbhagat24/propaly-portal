      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="mb-4">
              <img src="/logo.png" alt="Propaly Realtors" className="h-12 w-44 object-contain object-left" />
            </div>
            <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-xs">
              Helping you find not just homes, but a piece of Pune — its vibe, chaos, culture, and charm.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <span>📍</span>
                <span>Office No. 406, LMS Finswell, Viman Nagar, Pune 411014</span>
              </li>
              <li>
