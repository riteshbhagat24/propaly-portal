    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <a href={"https://wa.me/919999999999?text=" + encodeURIComponent(msg)} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white text-xs font-semibold px-4 py-2 rounded-xl hover:bg-[#20bd5a] transition-all">Enquire</a>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section id="properties" className="py-20 px-4 max-w-7xl mx-auto">
      ...
      <div className="text-center mt-12">
        <a href="https://wa.me/919999999999?text=Show%20me%20more%20properties" target="_blank" className="inline-flex items-center gap-2 border-2 border-[#0A1628] text-[#0A1628] font-semibold px-8 py-3 rounded-xl hover:bg-[#0A1628] hover:text-white transition-all">View All Properties</a>
      </div>
    </section>
  );
}`;
